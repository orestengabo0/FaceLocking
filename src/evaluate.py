...
Assumptions: - Enrollment crops exist under: data/enroll/<name>/*.jpg - Crops are aligned (112x112) already (as saved by enroll.py / haar_5pt pipeline) - Uses ArcFaceEmbedderONNX from embed.py (your working embedder) 
Outputs: - Prints summary stats for genuine/impostor cosine distances - Suggests a threshold based on a target FAR 
Run: 
